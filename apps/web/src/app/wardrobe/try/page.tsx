          ...
          {TOOLS.map((tool, idx) => (
            ...
            >
              {tool.link ? (
                <Link
                  href={tool.link}
                  className="group flex items-center gap-5 rounded-2xl border border-ink-900/10 bg-white p-5 shadow-card transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lift"
                >
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-ink-900/5 transition-colors duration-200 group-hover:bg-ink-900/10">
                    <tool.icon size={22} strokeWidth={1.5} className="text-ink-700" />
                  </div>
                ...
                <button
                  ...
                  className="group flex w-full items-center gap-5 rounded-2xl border border-ink-900/10 bg-white p-5 text-left shadow-card transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lift"
                >
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-ink-900/5 transition-colors duration-200 group-hover:bg-ink-900/10">
                    <tool.icon size={22} strokeWidth={1.5} className="text-ink-700" />
                  </div>
